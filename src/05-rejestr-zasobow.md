...
Do rejestru powinny trafiać co najmniej:

- strony i podstrony zawierające istotne informacje publiczne,
- treści obowiązkowe w BIP,
- dokumenty i załączniki,
- formularze do pobrania,
- multimedia,
- treści od innych podmiotów,
- treści z publikacją warunkową,
- zasoby wymagające przeglądu albo naprawy,
...
| Pole | Opis |
|---|---|
| Identyfikator zasobu | unikalny numer albo kod rekordu |
| Tytuł | nazwa zasobu |
| Adres URL | miejsce publikacji |
| Typ zasobu | strona, dokument, załącznik, multimedia, post, formularz |
| Źródło | własne, inna komórka, podmiot zewnętrzny |
| Właściciel merytoryczny | osoba albo komórka odpowiedzialna za treść |
| Redaktor publikujący | osoba, która opublikowała zasób |
| Data publikacji | data pierwszej publikacji |
| Data ostatniej aktualizacji | data ostatniej zmiany treści albo pliku |
| Status dostępności | dostępny, wymaga poprawy, niedostępny, oznaczony, wymaga decyzji |
| Wynik kontroli | publikuj, popraw, warunkowo, z oznaczeniem, odmowa |
| Status przeglądu | nie dotyczy, zaplanowany, w toku, zakończony, zaległy |
| Termin kolejnego przeglądu | data następnej oceny |
| Decyzja o dalszym losie | aktualizuj, pozostaw, napraw, archiwizuj, wycofaj |
| Uwagi | informacje pomocnicze |
| Powiązane zgłoszenia dostępności | numer zgłoszenia albo odwołanie do rejestru zgłoszeń |

Wzory rejestrów są opisane w rozdziale [Rejestry](narzedzia/rejestry.md).

## Jak rejestr wspiera przegląd i naprawę
...
## Jak rejestr wspiera żądania dostępności

Jeżeli użytkownik zgłasza brak dostępności, rejestr pozwala szybko ustalić:

- właściciela zasobu,
- datę publikacji,
- wynik ostatniej kontroli,
- wcześniejsze braki,
- decyzję o publikacji warunkowej,
...
- rejestr prowadzony tylko jako lista linków,
- brak właściciela merytorycznego,
- brak statusu dostępności,
- brak terminu przeglądu,
- automatyczne pomijanie starszych dokumentów bez oceny ich niezbędności dla bieżących zadań,
- nieaktualizowanie rejestru po naprawie albo archiwizacji,
- brak powiązania z formularzami i decyzjami publikacyjnymi.

## Powiązane narzędzia

Rejestr zasobów łączy się z [formularzami](narzedzia/formularze.md), [rejestrami pomocniczymi](narzedzia/rejestry.md), [przeglądem i naprawą](07-przeglad-i-naprawa.md), [archiwizacją](08-archiwizacja-i-wycofanie.md) oraz [obsługą treści od innych podmiotów](06-tresci-od-innych-podmiotow.md).
